    ...
    <div class='st-content-inner'>
      ...
      <div class='cover-info'>
       ...
       <img src='images/${requestScope.searchedUser.profilePic}' />
        ...
        <ul class='cover-nav'>
          <li class='active'><a href='PublicAbout.jsp?searchedUser=${requestScope.searchedUser.userEmail}'><i class='fa fa-fw fa-user'></i> About</a></li>
          <li><a href='PublicTimeline.jsp?searchedUser=${requestScope.searchedUser.userEmail}'><i class='fa fa-fw fa-ship'></i> Timeline</a></li>
          <li><a href='PublicFriends.jsp?searchedUser=${requestScope.searchedUser.userEmail}'><i class='fa fa-fw fa-users'></i> Friends</a></li>
          <li><a href='PublicEvents.jsp?searchedUser=${requestScope.searchedUser.userEmail}'><i class='fa fa-fw fa fa-fw fa-birthday-cake'></i> Events</a></li>
		      <li><a href='PublicGroup.jsp?searchedUser=${requestScope.searchedUser.userEmail}'><i class='fa fa-fw fa fa-fw fa-institution'></i>Groups</a></li>
        </ul>
<%
                  ...
                  <div class='panel panel-default profile-card clearfix-xs'>
                    <div class='panel-body'>
                      ...
                      <ul class='icon-list icon-list-block'>
                       <li><i class='fa fa-university'></i>${requestScope.searchedUser.userUniversity}</li>
                        <li><i class='fa fa-map-marker'></i>${requestScope.searchedUser.userCity}</li>
                        <li><i class='fa fa-book'></i>${requestScope.searchedUser.userMajor}</li>
                        <li><i class='fa fa-calendar'></i>${requestScope.searchedUser.leavingDate}</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class='timeline-block'>
                  <div class='panel panel-default profile-card clearfix-xs'>
                    <div class='panel-body'>
                      ...
                      <ul class='icon-list icon-list-block'>
                       <li><i class='fa fa-calendar'></i>${requestScope.searchedUser.userDOB}</li>
                        <li><i class='fa fa-venus-mars'></i>${requestScope.searchedUser.userGender}</li>
                        <li><i class='fa fa-phone'></i>${requestScope.searchedUser.userPhone}</li>
                        <li><i class='fa fa-envelope'></i>${requestScope.searchedUser.userEmail}</li>
                      </ul>
                    </div>
                  </div>
                </div>
