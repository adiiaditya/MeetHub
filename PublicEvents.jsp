              ...
              <div class='cover-info'>
               ...
               <img src='images/<%= searchedUser.profilepic %>' />
                ...
                <ul class='cover-nav'>
                  ...
                  <li class='active'><a href='PublicEvents.jsp?searchedUser=<%= searchedUser.email %>'><i class='fa fa-fw fa fa-fw fa-birthday-cake'></i> Events</a></li>
				...
				<div class="timeline-block">
                  <div class="panel panel-default event">
                    <div class="panel-heading title">
                     <center> <b>Events Created:</b> </center>
                    </div>
					</div>
					</div>
